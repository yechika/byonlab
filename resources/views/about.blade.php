    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="md:flex items-center gap-12">
            <div class="md:w-1/2 mb-10 md:mb-0">
                <img src="{{ asset('storage/high-angle-blue-chemical-substances-arrangement.jpg') }}" alt="About PT Biondi Loka Niaga" 
            ...
            <div class="md:w-1/2">
                ...
                <p class="text-gray-600 dark:text-gray-300 mb-4">
                    {{ lang(
                        'PT Biondi Loka Niaga adalah perusahaan Distributor Fluke Indonesia yang berpengalaman dalam menyediakan peralatan industri berkualitas tinggi untuk memenuhi kebutuhan beragam industri. Dengan pengalaman dan keahlian lebih dari 10 tahun, kami telah menjadikan diri kami sebagai mitra terpercaya bagi berbagai bisnis yang mencari solusi yang handal untuk meningkatkan proses industri mereka.',
                        'PT Biondi Loka Niaga is an experienced Fluke Indonesia Distributor company providing high-quality industrial equipment to meet the diverse needs of various industries. With over 10 years of experience and expertise, we have established ourselves as a trusted partner for businesses seeking reliable solutions to enhance their industrial processes.'
                    ) }}
                </p>
                <p class="text-gray-600 dark:text-gray-300 mb-4">
                    {{ lang(
